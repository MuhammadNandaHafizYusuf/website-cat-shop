...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/laporanpenjualan.css">
...
if (isset($_POST["kirim"])) {
    ...
    riwayat.id_pembeli=pembeli.id_pembeli WHERE status_penjualan='$status' AND  tanggal_penjualan BETWEEN '$tgl_mulai' AND '$tgl_selsei'");
...
<h2>Laporan Penjualan dari <?php echo $tgl_mulai ?> Hingga <?php echo $tgl_selsei ?></h2>
<form action="" method="post">
    <div class="row">
        ...
        <div class="col-md-2">
            <label for=""></label><br>
            <button class="btn btn-primary" name="kirim" id="lihat">Lihat</button>
...
<a class="download" target="_blank" href="download_laporan.php?tglm=<?php echo $tgl_mulai?>&tgls=<?php echo $tgl_selsei ?>>&status=<?php echo $status ?>">Download</a>
